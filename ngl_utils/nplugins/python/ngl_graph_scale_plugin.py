...
class NGL_GraphScalePlugin( QPyDesignerCustomWidgetPlugin ):
    """NGL_GraphScalePlugin(QPyDesignerCustomWidgetPlugin)
    ...
    def __init__(self, parent=None):
        ...
        super(NGL_GraphScalePlugin, self).__init__(parent)
